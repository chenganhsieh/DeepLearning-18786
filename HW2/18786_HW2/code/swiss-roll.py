...
x_train, y_train, x_test, y_test = sample_data(data_name='swiss-roll')

layer_sizes = [2, 16, 12, 1] # 16, 12
...
plot_loss(logs)
plot_decision_boundary(x_train,y_train,mlp.forward, None, "swissroll_adam.png", epochs, learning_rate, logs)
